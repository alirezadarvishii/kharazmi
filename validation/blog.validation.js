...
const blogValidationSchema = joi.object({
  ...
  description: joi.string().min(20).max(50).required().messages({ "string.empty": "فیلد خلاصه الزامی است!", "string.min": "دسکریپشن حدااقل 20 کاراکتر!", "string.max": "دسکریپشن حدااکثر 50 کاراکتر!" }),
  blogId: joi.allow(),
  _csrf: joi.allow(),
});
